...
export default {
  ...
  postTrip: tripData => fetch(`${url}/trips/`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Accept: 'application/json',
  ...
  addUser: userInfo => fetch(`${url}/users`, {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(userInfo),
  }),

  login: userInfo => fetch(`${url}/user_token`, {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(userInfo),
  }).then(res => res.json()),

  getUser: () => fetch(`${url}/user`, {
    headers: {
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: `Bearer ${token}`,
